      ...
      >
        <div className="p-6 sm:p-8">
          ...
          <p className="text-gray-300 text-center mb-6">
            Buyurtmangiz bekor qilindi. Hech qanday ayblov qo‘yilmagan.
          </p>
          <div className="bg-gray-700 rounded-lg p-4 mb-6">
            <p className="text-sm text-gray-400 text-center">
              Hisob-kitob jarayonida biror muammoga duch kelsangiz,
              qo‘llab-quvvatlash jamoamizga murojaat qiling.
            </p>
          </div>
