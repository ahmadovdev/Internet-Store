          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full px-3 py-2 pl-10 bg-gray-100 border border-gray-600 rounded-md shadow-sm
                ...
                <input
                  ...
                  className=" block w-full px-3 py-2 pl-10 bg-gray-100 border border-gray-100 
									rounded-md shadow-sm
									 placeholder-gray-100 focus:outline-none focus:ring-gray-500 
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className=" block w-full px-3 py-2 pl-10 bg-gray-100 border border-gray-600 
									rounded-md shadow-sm placeholder-gray-100 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
                  placeholder="••••••••"
                />
              </div>
            </div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className=" block w-full px-3 py-2 pl-10 bg-gray-100 border
									 border-gray-600 rounded-md shadow-sm placeholder-gray-100 focus:outline-none focus:ring-gray-500 focus:border-gray-500 sm:text-sm"
                  placeholder="••••••••"
                />
              </div>
            </div>
            ...
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-transparent 
							rounded-md shadow-sm text-sm font-medium text-white bg-purple-700
